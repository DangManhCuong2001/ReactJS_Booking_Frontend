...
class specialityManage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selectedOption: '',
            ...
            <div className="schedule-manage-container">
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-6 content-right form-group'>
...
export default connect(mapStateToProps, mapDispatchToProps)(specialityManage);
